...
/*             } */                                                    }
/*             while (true) { */                                       while (true) {
/*                 if (compare(array[j], pivot) > 0) { */                  if (compare(array[j], pivot) > 0) {
/*                     j --; */                                                j --;
/*                 } else { */                                             } else {
/*                     break; */                                               break;
/*                 } */                                                    }
...
/*         return i; */                                            return i;
/*     }; */                                                   };
/*     var sort = function (begin, end) { */                   var sort = function (begin, end) {
/*         var index = partition(begin, end); */                   var index = partition(begin, end);
/*         if (begin < index - 1)  */                              if (begin < index - 1) 
/*             sort(begin, index - 1); */                              sort(begin, index - 1);
/*         if (index < end)  */                                    if (index < end) 
/*             sort(index, end); */                                    sort(index, end);
/*     }; */                                                   };
/*     sort(0, array.length - 1); */                           sort(0, array.length - 1);
